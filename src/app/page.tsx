...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      <header className="border-b border-gray-800">
        ...
        <div className="flex items-center justify-between px-6 py-3">
          ...
          <div className="flex items-center gap-4">
            <button className="px-4 py-1.5 bg-orange-500 hover:bg-orange-600 rounded text-sm font-medium transition-colors duration-200">
              Ask
            </button>
      ...
      {/* Hero Section */}
      <section className="relative h-[600px] md:h-[500px] sm:h-[400px] overflow-hidden">
        {/* Background Image */}
        ...
        <div className="relative h-full max-w-7xl mx-auto px-6 flex flex-col justify-center">
          <div className="max-w-2xl">
            ...
            {/* Headline */}
            <h1 className="text-6xl md:text-5xl sm:text-4xl font-bold mb-4 leading-tight">
              {heroMarket.question}
            </h1>
            ...
            <div className="mb-6">
              ...
              <div className="flex gap-2 mb-2 h-2 rounded">
                <div 
                  className="bg-green-500 rounded-l animate-probability-grow"
      ...
      <div className="border-b border-gray-800 sticky top-0 bg-black z-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex gap-8 text-sm overflow-x-auto scrollbar-hide">
            {categories.map((cat) => (
              <button
                key={cat}
